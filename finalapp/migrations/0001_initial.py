    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('division', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='finalapp.division')),
            ],
        ),
        migrations.CreateModel(
            name='Etablisment',
            fields=[
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='finalapp.location')),
            ],
        ),
        migrations.CreateModel(
            name='Equipe',
            fields=[
                ...
                ('laboratoire', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='finalapp.laboratoire')),
            ],
        ),
        migrations.AddField(
            model_name='division',
            name='etablisment',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='finalapp.etablisment'),
        ),
        migrations.CreateModel(
            name='Directions',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='finalapp.equipe'),
        ),
        migrations.AddField(
            model_name='researcher',
            name='groups',
